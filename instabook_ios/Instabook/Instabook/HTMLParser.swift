...
public class HTMLParser {
    ...
    public var htmlString : NSString = ""
    ...
    */
    public init(html: NSString, encoding: UInt, option: CInt, inout error: NSError?) {
        if html.lengthOfBytesUsingEncoding(encoding) > 0 {
            ...
            let cur : [CChar]? = html.decomposedStringWithCompatibilityMapping.cStringUsingEncoding(NSUTF8StringEncoding)
            let url : String = ""
